...
void cena20(Jogo *jogo) {
	...
	SDL_Surface* Stexto = TTF_RenderText_Solid(jogo->fonte, "Rato Roedor: Senhora, eu posso te ajudar!", jogo->preto);
	...
	SDL_RenderCopy(jogo->renderer, jogo->irismuitotriste, NULL, &rectiris);
