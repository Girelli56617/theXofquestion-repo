...
void cenaposnucleo3(Jogo* jogo) {
	...
	SDL_Surface* Smensagem3 = TTF_RenderText_Solid(jogo->fonte,
		"Siri: Sim, a quantidade de cada produto gênico é proporcional ao número de cromossomos justamente", jogo->preto);
	...
	SDL_Surface* Smensagem4 = TTF_RenderText_Solid(jogo->fonte,
		"por esse ser o jeito da célula de contar quantos cromossomos X inativar!", jogo->preto);
	...
	SDL_Rect rectMensagem2 = { 10, 902, 1300, 80 };
