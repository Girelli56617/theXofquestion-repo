...
void cena29(Jogo* jogo) {
	...
	SDL_Surface* Stexto = TTF_RenderText_Solid(jogo->fonte,
		"Rato Roedor: Assim você poderá conseguir o gatinho dos seus sonhos e do seu seu coração!", jogo->preto);
	...
	SDL_RenderCopy(jogo->renderer, jogo->irismuitofeliz, NULL, &rectiris);
	...
	SDL_Rect rect2 = { 20, 892, 1700, 100 };
