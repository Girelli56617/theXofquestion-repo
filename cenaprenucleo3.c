...
void cenaprenucleo3(Jogo* jogo) {
	...
	SDL_Surface* Smensagem = TTF_RenderText_Solid(jogo->fonte,
		" Rato Roedor: A heterocromatina está na forma de blocos, com a cromatina correspondente ao X com o gene para", jogo->preto);
	...
	SDL_Surface* Smensagem2 = TTF_RenderText_Solid(jogo->fonte,
		" a cor laranja e para a cor preta marcados com suas respectivas cores, graças aos óculos mágicos. Para", jogo->preto);
	...
	SDL_Surface* Smensagem3 = TTF_RenderText_Solid(jogo->fonte,
		"obter a sua gatinha, o cromossomo X com o gene laranja deve ser inativado nessa célula.", jogo->preto);
